...
UPDATE Salespersons SET store='Miami' where staffID='5';

UPDATE Customers SET Email='ppicasso@gmail.com' where idCustomers='10001';
UPDATE Customers SET Email='lamarr_hd@hollywood.com' where idCustomers='20001';
UPDATE Customers SET Email='hello@nasa.gov' where idCustomers='30001';
