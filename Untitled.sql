...
CREATE TABLE IF NOT EXISTS `mydb`.`Invoices` (
  ...
  `Customers_idCustomers` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`invoice_number`, ` Cars_VIN`, `Salespersons_staff ID`, `Customers_idCustomers`),
  UNIQUE INDEX `invoice number_UNIQUE` (`invoice_number` ASC) VISIBLE,
  INDEX `fk_Invoices_ Cars_idx` (` Cars_VIN` ASC) VISIBLE,
